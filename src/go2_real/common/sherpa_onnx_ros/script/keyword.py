...
class KeywordSpotterNode:
    def __init__(self):
        ...
        rospy.Subscriber("move_obs", Bool, self.move_obs_callback)
    ...
    def move_obs_callback(self, msg):
        """收到move_obs话题后播放对应音频"""
        if msg.data:
            self.play_audio("move_obs_true")
        else:
            self.play_audio("move_obs_false")
    ...
    def play_audio(self, keyword):
        ...
        keyword_to_audio = {
            ...
            "初始化成功": "init.wav",
            "避障":"work.wav",
            "move_obs_true":"move_obs_true.wav",
            "move_obs_false":"receive.wav",
            "where": "where.wav",
            "1": "2_1.wav",
            "2": "2_2.wav",
            "3": "2_3.wav",
        ...
        # 默认回复音频文件
        default_audio = "unknown_command.wav"
